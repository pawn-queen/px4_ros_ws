...
static char toplevel_type_raw_source[] =
  ...
  "uint8 FRAME_GLOBAL = 0 # WGS84 global frame, MSL altitude. x/y = latitude/longitude (degrees \\xc3\\x97 1e7)\n"
  "uint8 FRAME_LOCAL_NED = 1 # Local NED frame. x/y = north/east position (meters \\xc3\\x97 1e4)\n"
  "uint8 FRAME_GLOBAL_RELATIVE_ALT = 3 # WGS84 global frame, altitude above home. x/y = latitude/longitude (degrees \\xc3\\x97 1e7)\n"
  "uint8 FRAME_GLOBAL_TERRAIN_ALT = 10 # WGS84 global frame, altitude above terrain. x/y = latitude/longitude (degrees \\xc3\\x97 1e7)\n"
  "\n"
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeSource source = {
    {px4_msgs__msg__OrbitStatus__TYPE_NAME, 24, 24},
    {msg_encoding, 3, 3},
    {toplevel_type_raw_source, 2198, 2198},
  };
  return &source;
}

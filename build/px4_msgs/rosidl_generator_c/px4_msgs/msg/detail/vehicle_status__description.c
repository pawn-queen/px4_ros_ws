  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0x57, 0x3d, 0x6f, 0x1a, 0x6c, 0x3f, 0xaf, 0xbc,
      0xed, 0x3e, 0xc7, 0x30, 0xdc, 0x37, 0xf1, 0x6e,
      0x96, 0xff, 0x05, 0x96, 0xb6, 0x4c, 0xc6, 0x51,
      0x51, 0x5b, 0x31, 0xb4, 0xb3, 0x50, 0x7c, 0x6f,
    }};
  return &hash;
}
...
static char px4_msgs__msg__VehicleStatus__FIELD_NAME__nav_state_display[] = "nav_state_display";
static char px4_msgs__msg__VehicleStatus__FIELD_NAME__accepts_offboard_setpoints[] = "accepts_offboard_setpoints";
...
static char px4_msgs__msg__VehicleStatus__FIELD_NAME__traffic_avoidance_system_present[] = "traffic_avoidance_system_present";
...
static rosidl_runtime_c__type_description__Field px4_msgs__msg__VehicleStatus__FIELDS[] = {
  ...
  {
    {px4_msgs__msg__VehicleStatus__FIELD_NAME__nav_state_display, 17, 17},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_UINT8,
      0,
      0,
  ...
  {
    {px4_msgs__msg__VehicleStatus__FIELD_NAME__accepts_offboard_setpoints, 26, 26},
    {
  ...
  {
    {px4_msgs__msg__VehicleStatus__FIELD_NAME__traffic_avoidance_system_present, 32, 32},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_BOOLEAN,
      0,
      0,
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {px4_msgs__msg__VehicleStatus__FIELDS, 41, 41},
    },
    {NULL, 0, 0},
  };
  if (!constructed) {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeSource source = {
    {px4_msgs__msg__VehicleStatus__TYPE_NAME, 26, 26},
    {msg_encoding, 3, 3},
    {toplevel_type_raw_source, 5610, 5610},
  };
  return &source;
}

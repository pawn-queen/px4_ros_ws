  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0xf6, 0x85, 0x2b, 0x2f, 0x06, 0x8f, 0xfa, 0xb8,
      0xca, 0xd3, 0xc3, 0x8f, 0x46, 0xa1, 0xec, 0xea,
      0x60, 0x1f, 0x92, 0x5c, 0x5b, 0xc7, 0x6c, 0x42,
      0x0f, 0xf3, 0x3f, 0xc5, 0xb9, 0xab, 0x10, 0x90,
    }};
  return &hash;
}
...
static char px4_msgs__msg__EstimatorStatusFlags__FIELD_NAME__cs_in_transition[] = "cs_in_transition";
static char px4_msgs__msg__EstimatorStatusFlags__FIELD_NAME__cs_heading_observable[] = "cs_heading_observable";
...
static rosidl_runtime_c__type_description__Field px4_msgs__msg__EstimatorStatusFlags__FIELDS[] = {
  ...
  {
    {px4_msgs__msg__EstimatorStatusFlags__FIELD_NAME__cs_in_transition, 16, 16},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_BOOLEAN,
      0,
      0,
  ...
  {
    {px4_msgs__msg__EstimatorStatusFlags__FIELD_NAME__cs_heading_observable, 21, 21},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_BOOLEAN,
      0,
      0,
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {px4_msgs__msg__EstimatorStatusFlags__FIELDS, 65, 65},
    },
    {NULL, 0, 0},
  };
  if (!constructed) {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeSource source = {
    {px4_msgs__msg__EstimatorStatusFlags__TYPE_NAME, 33, 33},
    {msg_encoding, 3, 3},
    {toplevel_type_raw_source, 6536, 6536},
  };
  return &source;
}

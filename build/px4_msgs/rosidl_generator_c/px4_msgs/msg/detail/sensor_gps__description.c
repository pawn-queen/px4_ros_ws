  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0xfb, 0xef, 0x1a, 0xcd, 0x77, 0x34, 0xfa, 0xb2,
      0x93, 0x77, 0x90, 0x6a, 0xe9, 0x0f, 0x64, 0x93,
      0xe9, 0xa0, 0x77, 0x24, 0xa6, 0xa2, 0x19, 0x97,
      0xfb, 0x8f, 0xd5, 0x1d, 0x67, 0x71, 0xb9, 0x58,
    }};
  return &hash;
}
...
static char px4_msgs__msg__SensorGps__FIELD_NAME__antenna_offset_x[] = "antenna_offset_x";
static char px4_msgs__msg__SensorGps__FIELD_NAME__antenna_offset_y[] = "antenna_offset_y";
static char px4_msgs__msg__SensorGps__FIELD_NAME__antenna_offset_z[] = "antenna_offset_z";
...
static rosidl_runtime_c__type_description__Field px4_msgs__msg__SensorGps__FIELDS[] = {
  ...
  {
    {px4_msgs__msg__SensorGps__FIELD_NAME__antenna_offset_x, 16, 16},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_FLOAT,
      0,
      0,
  ...
  {
    {px4_msgs__msg__SensorGps__FIELD_NAME__antenna_offset_y, 16, 16},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_FLOAT,
      0,
      0,
  ...
  {
    {px4_msgs__msg__SensorGps__FIELD_NAME__antenna_offset_z, 16, 16},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_FLOAT,
      0,
      0,
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {px4_msgs__msg__SensorGps__FIELDS, 40, 40},
    },
    {NULL, 0, 0},
  };
  if (!constructed) {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeSource source = {
    {px4_msgs__msg__SensorGps__TYPE_NAME, 22, 22},
    {msg_encoding, 3, 3},
    {toplevel_type_raw_source, 4773, 4773},
  };
  return &source;
}

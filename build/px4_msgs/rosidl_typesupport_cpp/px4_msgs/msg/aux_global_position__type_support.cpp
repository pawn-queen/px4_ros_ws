...
static const _AuxGlobalPosition_type_support_symbol_names_t _AuxGlobalPosition_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, px4_msgs, msg, AuxGlobalPosition)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, px4_msgs, msg, AuxGlobalPosition)),
  }
};
...
{
  return &::px4_msgs::msg::rosidl_typesupport_cpp::AuxGlobalPosition_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, px4_msgs, msg, AuxGlobalPosition)() {
  return get_message_type_support_handle<px4_msgs::msg::AuxGlobalPosition>();
}
